        ...
        codeScanner.apply {
            ...
            decodeCallback = DecodeCallback {
                runOnUiThread {
                    loading(true)
                    hasilqrcode = it.text
                    if (CekApatActivity.cekapat!!.kodeApat == hasilqrcode){
                        no_bak = CekApatActivity.cekapat!!.apat!!.noBak
                        lokasi = CekApatActivity.cekapat!!.apat!!.lokasi
                        kodeapat = CekApatActivity.cekapat!!.apat!!.kode
                        finish()
