...
class TtdFfBlok2Fragment : BottomSheetDialogFragment(), AnkoLogger {
    ...
    fun postK3(requestid: RequestBody, requestnama: RequestBody){
        api.ttdk3_ffblok2(ttd_k3, requestnama, requestid).enqueue(object :
    ...
    fun posspv(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdspv_ffblok2(signaturePadSupervisor, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
    ...
    fun posOperator(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdoperator_ffblok2(signaturePadOperator, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
