        ...
        codeScanner.apply {
            ...
            decodeCallback = DecodeCallback {
                runOnUiThread {
                    loading(true)
                    hasilqrcode = it.text
                    if (CekhydrantActivity.cekhydrant!!.kodeHydrant == hasilqrcode){
                        no = CekhydrantActivity.cekhydrant!!.hydrant!!.noBox
                        lokasi = CekhydrantActivity.cekhydrant!!.hydrant!!.lokasi
                        kodehydrant = CekhydrantActivity.cekhydrant!!.hydrant!!.kode
                        finish()
