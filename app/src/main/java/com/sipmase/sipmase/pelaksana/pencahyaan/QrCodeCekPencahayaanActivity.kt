        ...
        codeScanner.apply {
            ...
            decodeCallback = DecodeCallback {
                runOnUiThread {
                    loading(true)
                    hasilqrcode = it.text
                    if (CekPencahayaanActivity.cekpencahayaan!!.kodePencahayaan == hasilqrcode){
                        lokasi = CekPencahayaanActivity.cekpencahayaan!!.pencahayaan!!.lokasi
                        kodepencahayaan = CekPencahayaanActivity.cekpencahayaan!!.pencahayaan!!.kode
