...
class TtdEdgBlok2Fragment : BottomSheetDialogFragment(), AnkoLogger {
    ...
    fun postK3(requestid: RequestBody, requestnama: RequestBody){
        api.ttdk3_edgblok2(ttd_k3, requestnama, requestid).enqueue(object :
    ...
    fun posspv(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdspv_edgblok2(signaturePadSupervisor, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
    ...
    fun posOperator(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdoperator_edgblok2(signaturePadOperator, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
