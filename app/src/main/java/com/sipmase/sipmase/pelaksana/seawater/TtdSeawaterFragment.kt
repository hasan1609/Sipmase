...
class TtdSeawaterFragment : BottomSheetDialogFragment(), AnkoLogger {
    ...
    fun postK3(requestid: RequestBody, requestnama: RequestBody){
        api.ttdk3_seawater(ttd_k3, requestnama, requestid).enqueue(object :
    ...
    fun posspv(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdspv_seawater(signaturePadSupervisor, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
    ...
    fun posOperator(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdoperator_seawater(signaturePadOperator, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
