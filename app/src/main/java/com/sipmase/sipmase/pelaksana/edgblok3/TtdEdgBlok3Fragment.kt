...
class TtdEdgBlok3Fragment : BottomSheetDialogFragment(), AnkoLogger {
    ...
    fun postK3(requestid: RequestBody, requestnama: RequestBody){
        api.ttdk3_edgblok3(ttd_k3, requestnama, requestid).enqueue(object :
    ...
    fun posspv(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdspv_edgblok3(signaturePadSupervisor, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
    ...
    fun posOperator(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdoperator_edgblok3(signaturePadOperator, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
