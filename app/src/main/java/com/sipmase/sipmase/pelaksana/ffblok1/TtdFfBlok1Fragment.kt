...
class TtdFfBlok1Fragment : BottomSheetDialogFragment(), AnkoLogger {
    ...
    fun postK3(requestid: RequestBody, requestnama: RequestBody){
        api.ttdk3_ffblok(ttd_k3, requestnama, requestid).enqueue(object :
    ...
    fun posspv(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdspv_ffblok(signaturePadSupervisor, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
    ...
    fun posOperator(requestid: RequestBody, requestnama: RequestBody) {
        api.ttdoperator_ffblok(signaturePadOperator, requestnama, requestid).enqueue(object :
            Callback<PostDataResponse> {
            override fun onResponse(
                call: Call<PostDataResponse>,
                response: Response<PostDataResponse>
