...
import com.sipmase.sipmase.databinding.FragmentScheduleAparBinding
...
class ScheduleAparFragment : Fragment(), AnkoLogger {

    lateinit var binding: FragmentScheduleAparBinding
    var api = ApiClient.instance()
    lateinit var progressDialog: ProgressDialog
    var tahun: String? = null
    private lateinit var mAdapter: ScheduleAparAdapter
    var tw: String? = null
    val sheet = BottomSheetAddScheduleAparFragment()
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_schedule_apar, container, false)
        ...
        binding.btnTambahScheduleApar.setOnClickListener {
            sheet.show(requireActivity().supportFragmentManager, "BottomSheetAddScheduleFragment")
        }
