...
class BottomSheetExportAparFragment : BottomSheetDialogFragment(), AnkoLogger {
    ...
    override fun onCreateView(
        ...
        binding.btnsubmit.setOnClickListener {
            ...
            if (selectedRadioButtonId != -1 && tahun.isNotEmpty() && jabatan.isNotEmpty() && nama.isNotEmpty()){
                api.create_pdf(body,requesttw,requesttahun,requestjabatan,requestnama).enqueue(object :
