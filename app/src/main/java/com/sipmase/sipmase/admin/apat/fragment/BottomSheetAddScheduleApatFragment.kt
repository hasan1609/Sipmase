...
class BottomSheetAddScheduleApatFragment : BottomSheetDialogFragment(), AnkoLogger {
    ...
    lateinit var itemApatScheduleAdapter: ItemApatScheduleAdapter
    ...
    override fun onCreateView(
        ...
        binding.txtJudul.text = "Schedule APAT"
        ...
        binding.searchBar.setOnQueryTextListener(object : SearchView.OnQueryTextListener,
            ...
            override fun onQueryTextSubmit(query: String?): Boolean {
                itemApatScheduleAdapter.getFilter().filter(query)
                return true
            }

            override fun onQueryTextChange(newText: String?): Boolean {
                itemApatScheduleAdapter.getFilter().filter(newText)
                return true
            }
        ...
        binding.btnsubmit.setOnClickListener {
            sb = StringBuilder()
            var i = 0
            while (i < itemApatScheduleAdapter.lista.size) {
                val spiritualTeacher = itemApatScheduleAdapter.lista[i]
                sb!!.append(spiritualTeacher.kode)
                if (i != itemApatScheduleAdapter.lista.size - 1) {
                    sb!!.append("n")
                }
                i++
            ...
            if (selectedRadioButtonId != -1 && tanggal_cek!=null && itemApatScheduleAdapter.lista.size > 0 && tahun.isNotEmpty()){
                loading(true)
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    for (hasil in data!!.data!!) {
                        notesList.add(hasil)
                        itemApatScheduleAdapter = ItemApatScheduleAdapter(notesList, requireActivity())
                        binding.rvItem.adapter = itemApatScheduleAdapter
                        itemApatScheduleAdapter.notifyDataSetChanged()
                    }
                }
            }
        }
