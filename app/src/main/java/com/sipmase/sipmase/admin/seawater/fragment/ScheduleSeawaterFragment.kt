...
class ScheduleSeawaterFragment : Fragment(), AnkoLogger {

    lateinit var binding: FragmentScheduleSeawaterBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_schedule_seawater, container, false)
