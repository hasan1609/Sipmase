...
import com.sipmase.sipmase.databinding.FragmentBottomSheetExport2Binding
...
class BottomSheetExportAmbulanceFragment : BottomSheetDialogFragment(), AnkoLogger {

    lateinit var binding : FragmentBottomSheetExport2Binding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_bottom_sheet_export2, container, false)
        ...
        binding.btnsubmit.setOnClickListener {
            ...
            if (jabatan.isNotEmpty() && nama.isNotEmpty()){
                api.ambulanceku_pdf(id,body,requestjabatan,requestnama).enqueue(object :
