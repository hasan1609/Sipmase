package com.sipmase.sipmase.admin.edgblok1.fragment
...
import com.sipmase.sipmase.databinding.FragmentHasilEdgBlok1Binding
...
class HasilEdgBlok1Fragment : Fragment(), AnkoLogger {
    lateinit var binding: FragmentHasilEdgBlok1Binding
    var api = ApiClient.instance()
    lateinit var progressDialog: ProgressDialog
    var tahun: String? = null
    private lateinit var mAdapter: SchedleEdgBlok1Adapter
    var tw: String? = null
    val sheet = BottomSheetAddScheduleEdgBlok1Fragment()
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_hasil_edg_blok1,
            container,
            false
        )
                        ...
                        if (response.isSuccessful) {
                            ...
                            if (data!!.data!!.isEmpty()) {
                                ...
                                for (hasil in data.data!!) {
                                    notesList.add(hasil)
                                    mAdapter = SchedleEdgBlok1Adapter(notesList, requireActivity())
                                    binding.rvscheduleedgblok.adapter = mAdapter
                                    mAdapter.setDialog(object : SchedleEdgBlok1Adapter.Dialog {
