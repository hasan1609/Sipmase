...
class ScheduleAmbulanceFragment : Fragment(), AnkoLogger {

    lateinit var binding: FragmentScheduleAmbulanceBinding
    var api = ApiClient.instance()
    lateinit var progressDialog: ProgressDialog
    var tahun: String? = null
    private lateinit var mAdapter: ScheduleAmbulanceAdapter
    var tw: String? = null
    val sheet = BottomSheetAddScheduleAmbulanceFragment()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_schedule_ambulance, container, false)
        ...
        binding.btnTambahScheduleAmbulance.setOnClickListener {
