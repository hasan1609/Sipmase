...
class ItemKebisinganAdminAdapter(
    private val notesList: MutableList<KebisinganModel>,
    private val context: Context,

    ) : RecyclerView.Adapter<ItemKebisinganAdminAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_kebisingan, parent, false)
