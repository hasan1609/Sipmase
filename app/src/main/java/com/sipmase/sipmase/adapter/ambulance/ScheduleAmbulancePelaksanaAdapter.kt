package com.sipmase.sipmase.adapter.ambulance
...
class ScheduleAmbulancePelaksanaAdapter(
    private val notesList: MutableList<AmbulanceModel>,
    private val context: Context

) : RecyclerView.Adapter<ScheduleAmbulancePelaksanaAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (note.isStatus == 0) {
            ...
            holder.status.text = "Menungu Approve"
