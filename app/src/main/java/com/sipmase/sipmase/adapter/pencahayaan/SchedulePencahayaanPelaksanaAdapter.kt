...
class SchedulePencahayaanPelaksanaAdapter(
    private val notesList: MutableList<SchedulePencahayaanModel>,
    private val context: Context,

    ) : RecyclerView.Adapter<SchedulePencahayaanPelaksanaAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.list_schedule_pencahayaan, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.kode.text = note.kodePencahayaan
        holder.lokasi.text = note.pencahayaan!!.lokasi
        if (note.isStatus == 0) {
